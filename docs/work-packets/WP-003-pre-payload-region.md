...
**Pre-flight required:** Yes — this WP writes facts into [`docs/formats/tgifile-art.md`](../formats/tgifile-art.md). See [pre-flight gate](../reference/pre-flight.md) → "format documentation under `docs/formats/**` that locks a fact."
